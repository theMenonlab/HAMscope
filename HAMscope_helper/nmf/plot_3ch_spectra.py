...
# File paths
spectrum1_file = "/media/al/Extreme SSD/20250603_suberin/spectrum1.emn"
spectrum2_file = "/media/al/Extreme SSD/20250603_suberin/spectrum2.emn"
spectrum3_file = "/media/al/Extreme SSD/20250603_suberin/spectrum3.emn"
...
plt.plot(wavelengths, spectrum3_intensity, 'b', linewidth=3, label='Lignin')
plt.plot(wavelengths, spectrum2_intensity, 'g', linewidth=3, label='Suberin')
plt.plot(wavelengths, spectrum1_intensity, 'r', linewidth=3, label='Chlorophyll')
...
plt.legend(fontsize=12, frameon=True, fancybox=True, shadow=True, ncol=3, loc='upper left')
...
plt.xlim(450, 700)
plt.ylim(0, max(max(spectrum1_intensity), max(spectrum2_intensity), max(spectrum3_intensity)) * 1.1)
